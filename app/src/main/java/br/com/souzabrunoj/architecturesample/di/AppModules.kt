...
val presentationModules = module {
    factory { (activity: AppCompatActivity, navController: NavController) -> FeatureARouter(activity, navController) }
    ...
    viewModel { (activity: AppCompatActivity, navController: NavController) -> FeatureAViewModel(get { parametersOf(activity, navController) }) }
}
